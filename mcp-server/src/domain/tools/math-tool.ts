...
export function mathTools(server: McpServer) {
  // Math tool
  server.tool(
    "math-tool",
    `This is the mathematical operations tool. In this tool you can perform basic operations, such as addition, subtraction, division and multiplication.
